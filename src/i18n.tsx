...
const english: Record<string, string> = {
  ...
  改用手动发布: "Use manual publishing instead",
  ...
  "Markdown 编辑区域滚动容器": "Markdown editor scroll area",
  ...
  "密码为 12–128 位。": "Password length is 12–128 characters.",
  "使用 12–128 位密码；建议包含字母、数字和符号。":
    "Use 12–128 characters; letters, numbers, and symbols are recommended.",
  一次性邀请码: "Single-use invite code",
  "邀请码由站点管理员发放。可在项目介绍文章下评论或私信获取，每个邀请码仅能使用一次。":
    "Invite codes are issued by the site administrator. Comment on the project announcement or send a direct message to request one; each code can be used once.",
  ...
  邀请码记录: "Invite history",
  管理员邀请码: "Administrator invite",
  体验邀请码: "Trial invite",
  已使用: "Used",
  未使用: "Unused",
  撤销: "Revoke",
  "确认撤销这个未使用的邀请码？": "Revoke this unused invite code?",
  邀请码已撤销: "Invite revoked",
  尚无邀请码记录: "No invite history yet",
  管理员操作记录: "Administrator activity",
  创建邀请码: "Invite created",
  撤销邀请码: "Invite revoked",
  更新体验账号: "Trial account updated",
  管理员操作: "Administrator action",
  尚无管理员操作记录: "No administrator activity yet",
  "邀请码只显示在这里，请安全发给体验者。":
  ...
  常用标题: "Common headings",
  常用文字样式: "Common text styles",
  常用列表与引用: "Common lists and quotes",
  常用插入: "Common inserts",
  "撤销 (⌘Z)": "Undo (⌘Z)",
  "重做 (⇧⌘Z)": "Redo (⇧⌘Z)",
  标题: "Headings",
