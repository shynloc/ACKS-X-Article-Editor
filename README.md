...
> **当前版本：0.1.0 私有预览版。** 核心实现已进入验收阶段，尚未完成完整浏览器回归与真实 X 账户联调。当前没有 X 登录、上传、创建草稿或发布功能。“本地结构校验通过”不表示 X 已接受内容。详细证据与限制见 [验收记录](docs/ACCEPTANCE.md)。
...
| V1.1 | Mermaid 图形、有限块操作、富文本复制 | 未实施 |
